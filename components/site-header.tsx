      ...
      <div className="relative mx-auto flex w-full max-w-7xl items-center gap-3 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="ml-auto flex items-center gap-2 sm:gap-4 lg:pl-4">
          <details className="group relative md:hidden">
            ...
            <div className="absolute right-0 top-[calc(100%+0.75rem)] w-[min(22rem,calc(100vw-2rem))] rounded-[1.75rem] border border-white/10 bg-slate-950 p-4 shadow-2xl shadow-slate-950/40">
